#'
#' @title \verb{Kdot} difference estimation, untidy data
#'
#' @description
#' Estimates difference between two dot-type \emph{K} functions (\verb{Kdot}).
#'
#' @usage
#' K_Kdot2(ppp.marks,V.species="Species", host="Ash", V.bistate="Infected",
#'     yes="Yes",no="No",...,
...
#'
#' @seealso \code{\link{K_Kdot}} which does the same job,
#' \code{\link{g_gdot2}}, \code{\link{L_Ldot2}}, \code{\link{J_Jdot2}}, \code{\link{ND_NDdot2}},
...
#' @examples
#' \dontrun{
#' plot(K_Kdot2(ppp.marks.c3))
#' nsim=19
#' ev.k_kdot2.ash.c3<-envelope(ppp.marks.c3,K_Kdot2,nsim=nsim,
...
#' plot(ev.k_kdot2.ash.c3)
#' }
#'
K_Kdot2<-function(ppp.marks,V.species="Species", host="Ash",
