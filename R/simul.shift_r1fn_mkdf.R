...
#'
#' @usage simul.shift.r1fn.mkdf(ppp.marks,V.species="Species",sp="Cork",...,
...
#'  \code{\link{simul.jitter.r1f2.1mk}}, \code{\link{simul.jitter.r1fn.mkdf}},
...
#' @examples
#' \dontrun{
#' simul.shift.r1fn.mkdf(ppp.marks.c3,V.species="Species",sp="Cork",radius=0.1,edge="erode")
#' }
#'
simul.shift.r1fn.mkdf<-function(ppp.marks,V.species="Species",sp="Cork",...,
                           which=NULL, group, nsim=1, drop=TRUE){
