#' @title Cumulative Density Correlation Function, data 7
#'
#' @description
#' Estimates cum. density correlation function for univariate pattern with one quantitative marks.
#'
#' @usage
#' mkcorr.d7.t7(X, m.qti.1="DBH", r=NULL, verbose = TRUE, correction="Ripley",
#'     method="density",
...
#'
#' @details
#' The test function (test 7) for data 7 is
#' \deqn{C_{m,K}(r)=(m_{il}-\mu_l)(K_i(r)-K(r))}
...
#'
#' So this test is as same as \code{\link{mkcorr.t7}}. The only difference is that it
...
#'
#' @seealso \code{\link{mkcorr.d7.t8}}, \code{\link{mkcorr.d8.t7}},
#' \code{\link{mkcorr.t7}}, \code{\link{mkcorr.d7.t6}}.
#'
#' @author Tianzhong Jing \email{Jingtianzhong@163.com}
#'
#' @examples
#' \dontrun{
#' mkc.d7t7.g1<-mkcorr.d7.t7(ppp.ash.g1, m.qti.1="dbh", correction="translate")
#' plot(mkc.d7t7.g1)
#' nsim=2499
#' ev.mkc.d7t7.g1<-envelope(ppp.ash.g1, m.qti.1="dbh",mkcorr.d7.t7,
...
#' }
#'
mkcorr.d7.t7<-function(X, m.qti.1="DBH", r=NULL, verbose = TRUE,
                   correction="Ripley",
